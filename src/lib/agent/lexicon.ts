/**
 * Hostility lexicon for the heat score. Weights are calibrated so that a
 * single mild word never triggers action, while a directed multi-hit attack
 * lands in the collapse/flag band. Phrases are matched against normalized
 * text; single words against the token set.
 */

export const SEVERE_PHRASES: Record<string, number> = {
  "shut up": 0.5,
  "shut it": 0.5,
  "kill yourself": 1.4, // instant flag territory
